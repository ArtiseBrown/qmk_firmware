...
annotation_keycodes = { # keycodes with annotations
    "layer": {"keycodes": ["SHIFT_ED", "BSPC_CURSOR", "SYMBOLS", "CURSOR", "NUMPAD", "MOUSE", "FNKEYS"],
              "label": "layer"},
    "one-shot": {"keycodes": ["OS_SHFT", "OS_CTRL", "OS_ALT", "OS_CMD", "OS_HYPR"],
                 "label": "one-shot"},
...
layer_names = {
  "_BASE": "Base",
  "_CURSOR": "Cursor Control",
  "_SYMBOLS": "Symbols",
  "_NUMPAD": "Numpad",
  "_MOUSE": "Mouse Control",
  "_FNKEYS": "Function Keys",
  "_SYSTEM": "System",
  "_ADJUST": "Mouse &amp; Media"
}
...
key_names = {
    ...
    "OS_HYPR": {"label": "&#10022;", "title": "Hyper"},
    "APP_SWITCH_FRWD": {"label": "Switch App", "title": ""},
    "SHIFT_ED": {"label": "Shift /\n Edit", "title": ""},
    "BSPC_CURSOR": {"label": "BSPC /\n Cursor", "title": ""},
    "NUM": {"label": "Num", "title": ""},
    "NUMB": {"label": "Num", "title": ""},
    "SYMBOLS": {"label": "Symbols", "title": ""},
    "CURSOR": {"label": "Cursor", "title": ""},
    "NUMPAD": {"label": "Numpad", "title": ""},
    "MOUSE": {"label": "Mouse", "title": ""},
    "FNKEYS": {"label": "Fn Keys", "title": ""},
    ...
    "KC_MS_WH_DOWN": {"label": "&#8615;", "title": "Mouse wheel down"},
    "KC_MS_BTN1": {"label": "Left Click", "title": ""},
    "KC_MS_UP": {"label": "&#9650;", "title": ""},
    "KC_MS_BTN2": {"label": "Right Click", "title": ""},
    "KC_MS_ACCEL1": {"label": "Mouse Accel 1", "title": ""},
    "KC_MS_WH_UP": {"label": "&#8613;", "title": "Mouse wheel up"},
    "KC_MS_LEFT": {"label": "&#9664;", "title": ""},
    "KC_MS_DOWN": {"label": "&#9660;", "title": ""},
    "KC_MS_RIGHT": {"label": "&#9654;", "title": ""},
    ...
    "KC_EXCLAIM": {"label": "!", "title": ""},
    "KC_AT": {"label": "@", "title": ""},
    "KC_PERCENT": {"label": "@", "title": ""},
    "KC_CIRCUMFLEX": {"label": "^", "title": ""},
    "KC_AMPERSAND": {"label": "&amp;", "title": ""},
    "KC_DOLLAR": {"label": "$", "title": ""},
    "KC_EURO": {"label": "€", "title": ""},
    "KC_STERLING": {"label": "£", "title": ""},
    "KC_LOGIN": {"label": "Login", "title": "Windows Login"},
