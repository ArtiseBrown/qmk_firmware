...
#define RGB_MATRIX_LED_PROCESS_LIMIT DRIVER_LED_TOTAL / 6 // limits the NUM2er of LEDs to process in an animation per task run (increases keyboard responsiveness)
